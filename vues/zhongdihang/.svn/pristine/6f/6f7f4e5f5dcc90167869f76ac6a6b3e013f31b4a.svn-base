...
public interface DispatchService {
    ...
    //银行派单页面搜索框
    //===========================================
    Page<Dispatch> bankSearch(Date startDate,Date endDate,String search,PageRequest page);
    //===========================================
    //银行与机构页面搜索框
    //===========================================
    Page<BankDispatchCountDto> bankAndAssessSearch(String startDate,String endDate,String search,PageRequest page);
