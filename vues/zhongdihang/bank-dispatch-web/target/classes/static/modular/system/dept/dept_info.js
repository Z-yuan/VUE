...
DeptInfoDlg.addSubmit = function() {
    ...
    //提交信息
    var ajax = new $ax(Bank.publicPath + "/dept/add", function(data){
        Bank.success("添加成功!");
...
DeptInfoDlg.editSubmit = function() {
    ...
    //提交信息
    var ajax = new $ax(Bank.publicPath + "/dept/update", function(data){
        Bank.success("修改成功!");
        window.parent.Dept.table.refresh();
        DeptInfoDlg.close();
    },function(data){
...
$(function() {
    Bank.initValidator("deptInfoForm", DeptInfoDlg.validateFields);
