                    ...
                    responseHandler: function(res) {
                        if(res.code==1000){
                            if(!res.content.content){
                                return  res.content;   //数据
                            }else {
                                return {
                                    "rows": res.content.content,  //数据
                                    "total":res.content.totalElements //总页数
                                };
                            }
                        }else if(res.code==4006){
                            //参数验证失败
                        }else if(res.code==4003||res.code==4004){
